    ...
    <DashboardStandardPage titleKey="dash.twofa.title" breadcrumbLastKey="dash.twofa.title">
      ...
      <div className="rounded-[12px] border border-white/[0.08] bg-[#161b33] p-5 sm:p-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <span className="font-medium text-white">{t("dash.twofa.enable")}</span>
          <button
            type="button"
        ...
        {enabled ? (
          <div className="mt-8 border-t border-white/[0.08] pt-8">
            ...
            <div className="mt-4 flex h-40 w-40 items-center justify-center rounded-[12px] border border-dashed border-white/20 bg-[#14182b] text-xs text-slate-500">
              QR
            </div>
            <p className="mt-6 text-sm text-[#a0aec0]">{t("dash.twofa.backup")}</p>
            <div className="mt-2 rounded-[10px] border border-white/[0.08] bg-[#14182b] px-4 py-3 font-mono text-sm text-slate-400">
              •••• •••• •••• ••••
            </div>
            ...
            <input
              ...
              className="mt-2 w-full max-w-xs rounded-[10px] border border-[#2a3558] bg-[#14182b] px-4 py-2.5 text-sm text-white outline-none focus:border-[#2563eb]/50"
