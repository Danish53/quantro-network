...
export default function RoadmapCtaBanner() {
  ...
  return (
    <section
      ...
      aria-label={t("roadmap.cta.get_started")}
    >
      <div className="flex flex-col items-stretch justify-between gap-6 lg:flex-row lg:items-center">
        <p className="max-w-xl text-base font-medium leading-relaxed text-slate-100 sm:text-lg">{t("roadmap.cta.text")}</p>
