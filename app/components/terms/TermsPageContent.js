...
const WHY_KEYS = ["terms.integrations_why_1", "terms.integrations_why_2", "terms.integrations_why_3", "terms.integrations_why_4"];
const STRAT_KEYS = ["terms.integrations_strat_1", "terms.integrations_strat_2", "terms.integrations_strat_3", "terms.integrations_strat_4"];
  ...
  return (
    <div className="relative w-full min-w-0 overflow-x-hidden">
      ...
      <div className="relative mx-auto w-full max-w-3xl px-4 pb-8 pt-10 text-center sm:px-6 sm:pt-14 lg:px-10 lg:pt-16">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base text-slate-400 sm:text-lg">{t("terms.hero_subtitle")}</p>
      </div>
        ...
        <article className="overflow-hidden rounded-2xl border border-white/[0.08] bg-[#141235]/90 shadow-[0_24px_80px_rgba(0,0,0,0.45)] ring-1 ring-white/[0.05] backdrop-blur-sm">
          <div className="space-y-10 px-4 py-8 sm:px-10 sm:py-10">
            ...
            <section className="border-t border-white/[0.06] pt-10">
              <h2 className="text-lg font-semibold text-indigo-400 sm:text-xl">{t("terms.legal_heading")}</h2>
              <p className="mt-4 text-slate-300">{t("terms.legal_p1")}</p>
              <p className="mt-4 text-slate-300">{t("terms.legal_p2")}</p>
              <p className="mt-4 text-slate-300">{t("terms.legal_p3")}</p>
            </section>

            <section className="border-t border-white/[0.06] pt-10">
              <h2 className="text-lg font-semibold text-indigo-400 sm:text-xl">{t("terms.integrations_title")}</h2>
              <p className="mt-4 text-slate-300">{t("terms.integrations_intro")}</p>

              <h3 className="mt-8 text-base font-semibold text-white">{t("terms.integrations_why_title")}</h3>
              ...
              <h3 className="mt-8 text-base font-semibold text-white">{t("terms.integrations_strat_title")}</h3>
              <ul className="mt-4 space-y-3">
                {STRAT_KEYS.map((key) => (
                  <Bullet key={key}>{t(key)}</Bullet>
                ))}
